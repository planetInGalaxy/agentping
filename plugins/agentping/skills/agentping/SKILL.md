...
```bash
node scripts/config.mjs set-summary-range 20 45
...
- Prompt automatic summaries toward the configured `summaryMinChars` to `summaryMaxChars` range; defaults are 20 to 45 Chinese characters.
